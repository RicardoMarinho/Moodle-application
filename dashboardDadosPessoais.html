...
<body>
  ...
  <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
    <div class="w3-bar-padd">
      ...
      <a href="dashboardDadosPessoais.html" class="w3-bar-item w3-button w3-bar-border w3-bar-active"><i
        ...
        <section class="block block_myoverview  card mb-3">
          <div class="card-body p-3">
            <form class="navbarform">
              <a onclick="mostraDados()" class="w3-bar-item w3-button"><i class="fas fa-address-book"
                  aria-hidden="true"></i> Os meus dados </a>
              <a onclick="mostraEmail()" class="w3-bar-item w3-button"><i class="fas fa-at" aria-hidden="true"></i>
                Dados Login </a>
              <a onclick="mostraInteresses()" class="w3-bar-item w3-button"><i class="fas fa-heartbeat"
                  aria-hidden="true"></i> Interesses </a>
            </form>

            <form class="dadosform" id="meusDados" style="display:block;">

              <img class="minhafoto" src="images/perfilricardo.png" height="150" width="130" alt="Image preview...">
              <input type="file" onchange="seletorDeImagem()"><br><br>

              <label for="fname">Nome</label><br>
              <input type="textform" id="nome" class="boxform large" style="background-color: #EFF2FB" name="firstname"
                placeholder="Meu nome..."><br>

              <label for="lname">Data de Nascimento</label><br>
              <input type="date" class="boxform" id="dataNasc" style="width:200px; background-color: #EFF2FB"
                name="dataNascimento" placeholder="dd/mm/aaaa"><br>

              <label for="lname">Morada</label><br>
              <input type="textform" id="endereco" class="boxform large" style="background-color: #EFF2FB"
                name="lastname" placeholder="Morada..."><br>

              <label for="lname">Codigo Postal</label><br>
              <input type="textform" class="boxform" id="endereco" style="background-color: #EFF2FB" name="lastname"
                placeholder="Código Postal..." required pattern="\d{4}-\d{3}">

              <input type="textform" class="boxform" id="endereco" style="width:300px; background-color: #EFF2FB"
                name="lastname" placeholder="Localidade..."><br>
            </form>

            <form action="/action_page.php" class="dadosform" id="useremail" style="display:none;">
              <label for="fname">Username</label><br>
              <input type="textform" class="boxform" id="user" style="width:300px; background-color: #EFF2FB"
                name="username" placeholder="Username.."><br><br>

              <label for="fname">Palavra Passe</label><br>
              <input type="password" class="boxform" id="user" style="width:300px; background-color: #EFF2FB"
                name="username" placeholder="Password.."><br><br>

              <label for="fname">Endereço Electónico</label><br>
              <input type="email" class="boxform" id="user" style="width:500px; background-color: #EFF2FB"
                name="Emailadress" placeholder="Email.."><br><br>
            ...
            <form class="dadosform" class="boxform" id="meusinteresses" style="display:none;">
              ...
              <input type="textform" class="boxform" id="user" style="width:250px; background-color: #EFF2FB"
                name="Adefenir" placeholder="A definir.."> <br>
            </form>
          </div>
        </section>
