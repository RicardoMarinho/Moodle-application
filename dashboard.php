                ...
                <div class="block-myoverview block-cards">
                  <div class="d-flex align-items-center flex-wrap">
                    <div class="dropdown m-b-1 mr-auto">
                      <button type="button" class="btn btn-outline-secondary dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown"
                      ...
                      <div data-region="paged-content-page ">
                        <div class="card-deck dashboard-card-deck">
                            ...
                            <div class="card-body-class pr-1 course-info-container">
                              ...
                              <div class="card-footer dashboard-card-footer border-0 bg-white">
                                <div class="progress bg-white border">
                                  <div class="progress-bar bar" role="progressbar" aria-valuenow="0" style="width: 0%"
                          ...
                          <div class="card dashboard-card">
                            <a href="#">
                              <div class="card-img dashboard-card-img"
                                style="background-image: url(images/estatisticadescritiva.jpg)"></div>
                            </a>
                            <div class="card-body-class pr-1 course-info-container">
                              <div class="d-flex align-items-start">
                                <span class="multiline">
                          ...
                          <div class="card dashboard-card">
                            <a href="#">
                              <div class="card-img dashboard-card-img"
                                style="background-image: url(images/matematica.jpg)"></div>
                            </a>
                            <div class="card-body-class pr-1 course-info-container">
                              <div class="d-flex align-items-start">
                                <span class="multiline">
                ...
                <div class="block-timeline">
                  <div class="container pb-3 border-bottom">
                    <div class="row no-gutters">
                      <div class="col-sm d-flex justify-content-start">
                        <div class="dropdown">
                          <button type="button" class="btn btn-outline-secondary dropdown-toggle icon-no-margin"
                  ...
                  <div class="container p-0">
                    <div class="text-xs-center text-center mt-3" data-region="empty-message"
                      id="yui_3_17_2_1_1555612201078_1469">
                      <img src="images/activities.svg" alt="No upcoming activities due"
